...
/// used within this feature's PIN pages, so it stays out of
/// `ondam_design_system` per ui-design.md ("두 개 이상의 feature가 공유하는
/// 위젯만 core/design_system에 둔다").
class PinKeypad extends StatelessWidget {
  ...
  static const double _keySize = 56;
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            const SizedBox(width: _keySize + AppSpacing.xs * 2),
            Padding(
