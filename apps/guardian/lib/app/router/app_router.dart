...
/// Central route table for the Guardian app. Feature pages register their
/// routes here instead of each widget managing its own navigation. This
/// router is independent from the Senior app's — the two apps never share
/// a router (see architecture.md).
///
...
class _PlaceholderHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('ondam_guardian')));
  }
}
