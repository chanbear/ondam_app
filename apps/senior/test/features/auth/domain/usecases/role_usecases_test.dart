...
import 'package:ondam_senior/features/auth/domain/usecases/add_role_usecase.dart';
import 'package:ondam_senior/features/auth/domain/usecases/get_roles_usecase.dart';
...
void main() {
  ...
  test('addRole delegates the chosen role to the repository', () async {
    await addRole(UserRole.elder);
    expect(repository.addRoleCalls, [UserRole.elder]);
  });
