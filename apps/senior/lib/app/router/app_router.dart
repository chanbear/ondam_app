...
/// Central route table for the Senior app. Feature pages register their
/// routes here instead of each widget managing its own navigation. This
/// router is independent from the Guardian app's — the two apps never share
...
class _PlaceholderHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('ondam_senior')));
  }
}
