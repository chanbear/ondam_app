...
/// [seniorIdleTimeout]. Instantiated once at the app root (see app.dart) —
/// not per-screen, and not a StatefulWidget's local state, since it drives
/// a global routing decision (flutter.md: StatefulWidget is for local UI
/// state only).
