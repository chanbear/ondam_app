...
/// idle timeout (see idle_timeout_controller.dart). This is why it is a
/// plain `Notifier<bool>` with no restore step, unlike `easyModeProvider`
/// in `core/easy_mode/`, which intentionally does persist.
